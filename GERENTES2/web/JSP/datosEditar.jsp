    ...
    <body>
            ...
            try{
               ...
               Id_Reporte = info.getString("Id_Reporte");
                ...
                Id_Admini= request.getParameter("Id_Admini");;
                ...
                String dato = "update Reporte set Id_Admini=2, Estado='"+Estado+"',Fecha='"+FechaNueva
                +"',Hora='"+HoraNueva+"',Solucion='"+Solucion+"' where Id_Reporte='"+Id_Reporte+"'";
